---
title: "Serie de tiempo cáncer de Piel en Antofagasta"
output:
  html_document:
    df_print: paged
...
-   MORF_GRUPO (PIEL):
    ...
    -   2=Neoplasias de células basales;
...
```{r, casos_base, echo=F}
table(factor(bd_$BASE, levels = c(0,1,6,7),
             labels = c("Solo DCO",
                        "Clínica",
                        "Histología de MTS",
...
round(prop.table(table(factor(bd_$BASE, levels = c(0,1,6,7), 
                              labels = c(
                                "Solo DCO",
                                "Clínica",
                                "Histología de MTS",
...
### Gráfico de la tasa de incidencia de cáncer de Piel (no melanoma), ajustada por edad en la región de Antofagasta.
```{r, plot_tasa_ajustada, echo=F}
plot(data_poblacion_tasa_ajustada_rafta,
     ylim=c(20,80),
     ylab="Tasa incidencia ajustada por 100 mil",
     xlab="Años", 
     main="Tasas de incidencia por cáncer de Piel, región de Antofagasta", 
     type="b")
```
...
age_year_hombres <- subset(bd_, SEXO == 1)
age_year_mujeres <- subset(bd_, SEXO == 2)
...
### Gráfico de la tasa de incidencia de cáncer de Piel, ajustada por edad y sexo en la región de Antofagasta.
...
table(factor(bd_1$BASE, levels = c(0,1,6,7),
             labels = c("Solo DCO",
                        "Clínica",
                        "Histología de MTS",
                        "Histología de sitio primario")
...
round(prop.table(table(factor(bd_1$BASE, levels = c(0,1,6,7), 
                              labels = c(
                                "Solo DCO",
                                "Clínica",
                                "Histología de MTS",
...
### Gráfico de la tasa de incidencia de cáncer de Piel (no melanoma), ajustada por edad en Comuna de Antofagasta
```{r, plot_tasa_ajustada_afta, echo=F}
plot(data_poblacion_tasa_ajustada_cafta,
     ylim=c(35,100),
     ylab="Tasa incidencia ajustada por 100 mil",
     xlab="Años", 
     main="Tasas de incidencia por cáncer de Piel, comuna de Antofagasta", 
     type="b")
```
...
age_year_hombres <- subset(bd_, SEXO == 1 & REGCOM == "02101")
age_year_mujeres <- subset(bd_, SEXO == 2 & REGCOM == "02101")
...
### Gráfico de la tasa de incidencia de cáncer de Piel, ajustada por edad y sexo en la comuna de Antofagasta.
...
table(factor(bd_2$BASE, levels = c(0,1,6,7),
             labels = c("Solo DCO",
                        "Clínica",
                        "Histología de MTS",
                        "Histología de sitio primario")
...
round(prop.table(table(factor(bd_2$BASE, levels = c(0,1,
                                                         6,7), 
                              labels = c(
                                "Solo DCO",
                                "Clínica",
...
### Gráfico de la tasa de incidencia de cáncer de piel (No melanoma), ajustada por edad en Comuna de Calama
...
age_year_hombres <- subset(bd_, SEXO == 1 & REGCOM == "02201")
age_year_mujeres <- subset(bd_, SEXO == 2 & REGCOM == "02201")
...
### Gráfico de la tasa de incidencia de cáncer de Piel, ajustada por edad y sexo en la comuna de Calama
...
### Gráfico de la tasa de incidencia de cáncer de Piel (No melanoma), ajustada por edad en Comuna de Tocopilla
...
## Tasa de incidencia ajustada por edad y sexo, según año. Comuna de Tocopilla

```{r, group_by_TIA_sex_toco, echo=F, include=F}
age_year_hombres <- subset(bd_, SEXO == 1 & REGCOM == "02301")
age_year_mujeres <- subset(bd_, SEXO == 2 & REGCOM == "02301")
...
### Gráfico de la tasa de incidencia de cáncer de Piel, ajustada por edad y sexo en la comuna de Tocopilla
...
# Plot tasas de incidencia por cáncer de Piel (No melanoma)
