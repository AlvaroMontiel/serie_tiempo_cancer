...
### Gráfico de la tasa de incidencia de cáncer de vejiga, ajustada por edad y sexo en la región de Antofagasta.
...
### Gráfico de la tasa de incidencia de cáncer de Vejiga, ajustada por edad y sexo en la comuna de Antofagasta.
...
### Gráfico de la tasa de incidencia de cáncer de Vejiga, ajustada por edad y sexo en la comuna de Calama.
...
plot(data_poblacion_tasa_ajustada_calama_hombres$YEAR_DIAG,
     ...
     ylab="Tasa incidencia ajustada por 100 mil",
     xlab="Años", 
     main="Tasas de incidencia por cáncer de Vejiga, comuna de Calama", 
     type="b",
     pch=16,
     col="red")
...
```{r, group_by_TIA_sex_Tocopilla, echo=F, include=F}
...
```{r, poblaciones_sex_Tocopilla, echo=F, include=F}
### AGREGAR POBLACION ESTANDAR
by_age_year_hombres = by_age_year_hombres %>% mutate(POB_STANDAR = case_when(
  AGE_GROUP == 1 ~ 12000,
  AGE_GROUP == 2 ~ 10000,
...
```{r, trasponer_data_poblacion_sex_Tocopilla, echo=F, include=F}
### CREAR UN NUEVO DATAFRAME CON LA POBLACION POR ANO Y GRUPO DE EDAD
posicion = 2
year = 2003
data_poblacion_hombres = data.frame()
...
```{r, merge_data_poblacion_con_data_by_mes_year_sex_Tocopilla, include=F, echo=F}
...
```{r,calculo_tasa_incidencia_ajsutada_edad_sex_Tocopilla, echo=F}
### Hombres
data_poblacion_tasa_hombres$EXPECTED_CASES <- data_poblacion_tasa_hombres$n * 
  data_poblacion_tasa_hombres$POB_STANDAR / data_poblacion_tasa_hombres$POB
...
```{r, plot_tasa_ajustada_sex_Tocopilla, echo=F}
